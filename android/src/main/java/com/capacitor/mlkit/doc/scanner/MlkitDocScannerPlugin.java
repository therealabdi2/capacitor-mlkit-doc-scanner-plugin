...
public class MlkitDocScannerPlugin extends Plugin {
      ...
      .registerForActivityResult(
        ...
        activityResult -> {
          ...
          if (activityResult.getResultCode() == Activity.RESULT_OK) {
            ...
            GmsDocumentScanningResult gmsResult =
            ...
            savedCall.reject(
              "Scan cancelled or failed. Result code: " +
  ...
  public void scanDocument(PluginCall call) {
    ...
    boolean galleryImportAllowed = call.getBoolean(
    ...
    GmsDocumentScannerOptions.Builder optionsBuilder =
